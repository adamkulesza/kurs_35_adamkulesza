...
print(
    f"Czas trwania treningu: {prawdziwy_czas_treningu} minut"
)  # 003_003 - printujemy prawdziwy czas treningu
print(
    f"Wykorzystalismy {(prawdziwy_czas_treningu / czas_treningu) * 100} % planu"
)  # 004 Procent wykorzystania planu
