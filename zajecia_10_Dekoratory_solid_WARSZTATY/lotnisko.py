...
# Chcemy aby ta nasza aplikacja juz nie byla glucha dla nas dla programistow, zebysmy logi sobie zaimplementowali.
# Implementacje takich logow jest czyms co mozemy zrobic za pomoca dekoratora. Tworzymy sobie plik <monitoring>.
# stworz plik <monitoring> i przejdz tam do punktu # 1.

# 2. Piszemy

from monitoring import monitor

# nastepnie nad kazda z funkcji powiedziec ze ona bedzie monitorowana - dodac @monitor.
# pozwoli nam to na to ze jak uruchomimy program to oprocz normalnej informacji dostaniemy tez informacje z monitora
#
# Starting executing of the function...
# function execution completed.
# [Jan Kowalski (LO123, 12A), Anna Nowak (LO123, 12B)]
#
# Nastepnie przechodzimy do pliku monitoring do punktu # 3.
